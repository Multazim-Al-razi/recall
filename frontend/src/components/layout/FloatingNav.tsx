  ...
  return (
    <>
      <motion.nav
        ...
        className="fixed top-3 left-1/2 z-50 flex h-[52px] w-[calc(100%-24px)] max-w-[640px] -translate-x-1/2 items-center justify-between gap-1.5 rounded-full border border-ink/5 bg-surface/70 px-2.5 shadow-[0_2px_16px_rgba(0,0,0,0.06)] backdrop-blur-[24px] backdrop-saturate-150 sm:top-5 sm:w-auto"
      >
        <button
          onClick={() => go('/')}
