...
import workTime from "@/assets/illustrations/undraw/work-time_1ogn.svg";
...
import makeItRain from "@/assets/illustrations/undraw/make-it-rain_ylfg.svg";

// Storyset illustrations (Freepik) — attribution required (see credits.ts).
// Accents recolored to the Rausch sienna family via
// scripts/recolor-storyset-accent.mjs so they sit beside unDraw on screen.
import storysetSupport from "@/assets/illustrations/storyset/business-support-pana.svg";
...
export const illustrations = {
  ...
  notification: {
    src: workTime,
    alt: "Person managing renewal timing and reminders at their desk",
    collection: "unDraw",
  },
  ...
  privacy: {
    src: allChecked,
    alt: "Checklist with all items verified, representing data privacy and security",
    collection: "unDraw",
  },
  ...
  pricing: {
    src: emptyWallet,
    alt: "A wallet, representing pricing and the cost of your subscriptions",
    collection: "unDraw",
  },
  ...
  celebration: {
    src: makeItRain,
    alt: "Person surrounded by falling money, celebrating savings",
    collection: "unDraw",
  },
  ...
  /** About hero — a team supporting one another, "built by people who care". */
  aboutSupport: {
    src: storysetSupport,
    alt: "People supporting and helping one another, representing a community-built product",
    collection: "Storyset",
  },
  /** About — managing money in a wallet, "your true monthly spend". */
  aboutWallet: {
    src: storysetWallet,
    alt: "A wallet holding cards and money, representing managing recurring spend",
    collection: "Storyset",
  },
