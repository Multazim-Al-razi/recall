...
const inputClass =
  'mt-1 w-full rounded-[10px] border border-ink/10 bg-canvas px-3.5 py-2.5 text-sm focus:border-rausch focus:outline-none';
    ...
    >
      {atLimit ? (
        <div
          ...
          className="w-full max-w-[400px] rounded-[20px] bg-surface p-8 text-center shadow-[0_20px_60px_rgba(0,0,0,0.2)]"
        >
        ...
        <form
          ...
          className="max-h-[90vh] w-full max-w-[440px] overflow-y-auto rounded-[20px] bg-surface p-6 shadow-[0_20px_60px_rgba(0,0,0,0.2)] sm:p-7"
        >
