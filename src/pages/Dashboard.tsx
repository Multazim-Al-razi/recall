    ...
    >
      ...
      <div className="mx-auto mt-6 max-w-[1280px] px-5 sm:px-8 md:mt-8 md:px-12">
        ...
        <section className="mt-3.5 grid grid-cols-1 gap-3.5 md:grid-cols-12">
          ...
          <div className="flex min-h-[180px] flex-col justify-between rounded-[18px] bg-dark p-6 text-[#f5f0eb] md:col-span-7 lg:col-span-8">
            <div>
            ...
            <Link to="/analytics" className="mt-5 inline-flex items-center gap-1.5 text-[13px] font-medium text-rausch">
              Open analytics
              <ArrowRight size={15} />
            </Link>
          </div>
        ...
        <section className="mt-10">
          <div className="mb-5 flex items-baseline justify-between">
            ...
            <Link to="/subscriptions" className="inline-flex items-center gap-1 text-[13px] font-medium text-muted transition-colors hover:text-ink">
