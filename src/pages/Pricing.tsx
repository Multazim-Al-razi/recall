  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1280px] px-5 sm:px-8 md:px-12">
        {/* Header */}
        <section className="flex flex-col items-center gap-8 pt-6 pb-10 text-center md:flex-row md:gap-12 md:pt-8 md:text-left">
          ...
          {PLAN_ORDER.map((tier) => {
            ...
            return (
              <motion.div
                ...
                className={`relative flex flex-col rounded-[22px] bg-surface p-6 transition-all ${
