...
const inputClass =
  'mt-1.5 w-full rounded-[12px] border border-ink/10 bg-canvas px-4 py-2.5 text-[15px] focus:border-rausch focus:outline-none';
    ...
    >
      <div className="mx-auto max-w-[1080px] px-5 sm:px-8 md:px-12">
        ...
        <div className="grid grid-cols-1 gap-4 pb-10 lg:grid-cols-[1.4fr_1fr]">
          {/* Account settings */}
          <div className="rounded-[20px] bg-surface p-7">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4 rounded-[20px] bg-surface p-5">
