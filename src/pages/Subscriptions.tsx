      ...
      <div className="mx-auto max-w-[1280px] px-5 sm:px-8 md:px-12">
        ...
        {categoryArt && filtered.length > 0 && (
          <motion.div
            ...
            className="mb-7 flex items-center justify-between gap-4 overflow-hidden rounded-[20px] bg-surface px-6 py-5 md:px-8 md:py-6"
          >
            <div>
        ...
        <div className="pb-12">
          {filtered.map((sub) => {
            ...
            return (
              <div
                key={sub.id}
                className="mb-2.5 flex flex-wrap items-center gap-x-4 gap-y-3 rounded-[16px] bg-surface px-4 py-4 sm:flex-nowrap sm:gap-5 sm:px-6 sm:py-5"
              >
                <div
          ...
          {filtered.length === 0 && (
            <div className="flex flex-col items-center justify-center rounded-[20px] border-2 border-dashed border-ink/8 py-16 text-center">
              {categoryArt ? (
                <img
                  src={categoryArt.src}
                  alt=""
